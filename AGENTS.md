...
2. Frontmatter holds `name` and `description` only. Write the description in third person, state what the skill does and when to use it, and include the `/name` trigger. No XML tags, under 1024 characters.
